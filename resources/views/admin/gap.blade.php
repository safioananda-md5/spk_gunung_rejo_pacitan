...
@section('content')
    <div class="col-lg-12 grid-margin stretch-card">
        <ul class="nav nav-pills" id="pills-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link active" id="pills-gap-tab" href="{{ route(Auth::user()->role . '.gap') }}" role="tab"
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header">
                Perhitungan Pemetaan Gap Tiap Alternatif
                    ...
                    <table class="table" id="alternativeTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Nilai Profil Ideal</th>
                                ...
                                <tr>
                                    ...
                                    @foreach ($alternative->criteria_alternative as $CS)
                                        @if ($loop->first)
                                            ...
                                            <td class="text-center">
                                                {{ $CS->criteria->sub_criteria->first()->scale }}
                                            </td>
                                            <td class="text-center">
